...
1. Once the modules are installed you will need to edit the `config.json` file to include your setting requirements. Detailed information can be found in the 'Config File' section. 
